...
#at the association between sex (sex_cat) as the x = variable and each of nsibs, sleep_wkdy, and sleep_wknd, and income.
...
#5 - Instead of odds ratios for wearing glasses, as in the example, we want risk
...
#prompt you to install new package(s) (yes!).
